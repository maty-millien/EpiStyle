...
export const DOCKER_START_TIMEOUT_MS = 15_000;
export const DOCKER_STOP_TIMEOUT_MS = 5_000;
export const DOCKER_EXEC_TIMEOUT_MS = 30_000;
export const DOCKER_INSPECT_TIMEOUT_MS = 5_000;
export const DOCKER_PREFLIGHT_TIMEOUT_MS = 5_000;
export const CONTAINER_NAME_PREFIX = "epistyle";
export const RESTART_CONTAINERS_COMMAND = `${CONFIG_SECTION}.restartContainers`;
